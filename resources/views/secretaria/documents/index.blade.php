                    ...
                    <tbody id="documents-table">
                        @foreach($documents as $document)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('secretaria.documents.edit', $document->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="{{ route('secretaria.documents.show', $document->id) }}" class="btn btn-info btn-sm">View</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                    ...
                    success: function(data){
                        ...
                        $.each(data.documents, function(index, document) {
                            var row = '<tr>' +
                                ...
                                '<td>' + document.received_date + '</td>' +
                                '<td>' +
                                    '<a href="/secretaria/documents/' + document.id + '/edit" class="btn btn-warning btn-sm">Edit</a> ' +
                                    '<a href="/secretaria/documents/' + document.id + '" class="btn btn-info btn-sm">View</a> ' +
                                '</td>' +
                            '</tr>';
